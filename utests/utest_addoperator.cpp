/*
	Tests the addition operation of our array, representative for all operations
	Author: Urs Hofmann
...
int main()
{
	...
	{
		printf("something went wrong during shallow addition\n");
		throw "InvalidValue";
	}
	...
	if (!isSame)
	{
		printf("Addition using operator somehow went wrong\n");
		throw "InvalidValue";
	}
	...
	if (!isSame)
	{
		printf("Addition after assignment operator somehow went wrong\n");
		throw "InvalidValue";
	}
	...
	if (!isSame)
	{
		printf("Addition of two volumes with each other did not work out\n");
		throw "InvalidValue";
	}
